...
df <- read.csv('https://raw.githubusercontent.com/TZstatsADS/ads-spring2023-project2-group9/main/data/DOF_Condominium_Comparable_Rental_Income_in_NYC.csv?token=GHSAT0AAAAAAB5UZBVW76WAYNJ4KYXIDJFIY7VSCYA')
...
qns_zip <- read_delim("https://raw.githubusercontent.com/TZstatsADS/ads-spring2023-project2-group9/main/data/DOF__Cooperative_Comparable_Rental_Income___Queens___FY_2011_2012.csv?token=GHSAT0AAAAAAB5UZBVXJU6CCDFSN6MDBHPKY7VSE4Q", delim = ",", locale = locale(encoding = "UTF-8"))
man_zip <- read_delim('https://raw.githubusercontent.com/TZstatsADS/ads-spring2023-project2-group9/main/data/DOF__Condominium_comparable_rental_income___Manhattan_-_FY_2010_2011.csv?token=GHSAT0AAAAAAB5UZBVXW7TUCLZ6V6Q3XMQSY7VSF3Q', delim = ",", locale = locale(encoding = "UTF-8"))
brx_zip <- read_delim('https://raw.githubusercontent.com/TZstatsADS/ads-spring2023-project2-group9/main/data/DOF__Condominium_Comparable_Rental_Income___Bronx___FY_2009_2010.csv?token=GHSAT0AAAAAAB5UZBVWDDXP5ULLSVWVI2FYY7VSGLA', delim = ",", locale = locale(encoding = "UTF-8"))
bro_zip <- read_delim('https://raw.githubusercontent.com/TZstatsADS/ads-spring2023-project2-group9/main/data/DOF__Condominium_comparable_rental_income___Brooklyn_-_FY_2010_2011.csv?token=GHSAT0AAAAAAB5UZBVWU3G6G5UJVY63SNDCY7VSGXA', delim = ",", locale = locale(encoding = "UTF-8"))
si_zip <- read_delim('https://raw.githubusercontent.com/TZstatsADS/ads-spring2023-project2-group9/main/data/DOF__Condominium_Comparable_Rental_Income__Staten_Island___FY_2009_2010.csv?token=GHSAT0AAAAAAB5UZBVXP63MIGBIB642YVZYY7VSHCQ', delim = ",", locale = locale(encoding = "UTF-8"))
